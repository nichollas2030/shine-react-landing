    ...
    <footer className="bg-tc-neutral-900 text-white">
      ...
      <div className="container-responsive py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <h4 className="font-heading font-bold text-lg mb-6">Contato & Áreas</h4>
            ...
            {/* Service Areas */}
            <div>
              <h5 className="font-semibold text-tc-primary-400 mb-3">Atendemos:</h5>
              <div className="grid grid-cols-2 gap-1 text-sm text-tc-neutral-400">
                {companyContent.serviceAreas.slice(0, 6).map((area) => (
                  <div key={area}>• {area}</div>
                ))}
              </div>
              <p className="text-xs text-tc-neutral-500 mt-2">E região metropolitana</p>
            </div>
          </motion.div>
        </div>
      </div>
