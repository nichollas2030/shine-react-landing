...
export default function ServicesGrid() {
  return (
    <section className="py-16 lg:py-24 bg-tc-neutral-50">
      <div className="container-responsive">
        ...
        >
          ...
          <p className="text-responsive-body text-tc-neutral-600 max-w-3xl mx-auto">
            Soluções completas de limpeza para todas as suas necessidades, com
            qualidade profissional e atenção aos detalhes.
          </p>
        </motion.div>
              ...
              <div className="card-service h-full">
                ...
                <ul className="space-y-2 mb-6">
                  {service.features.map((feature, featureIndex) => (
                    <li
                      key={featureIndex}
                      className="flex items-center text-sm text-tc-neutral-700"
                    >
                      <svg
                        className="w-4 h-4 text-tc-primary-500 mr-2 flex-shrink-0"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    window.open(
                      `https://wa.me/15615231300?text=${encodeURIComponent(
                        message
                      )}`,
                      "_blank"
                    );
        ...
        >
          <p className="text-tc-neutral-600 mb-6">
            Não encontrou exatamente o que precisa? Oferecemos soluções
            personalizadas.
          </p>
          <Button
            variant="primary"
